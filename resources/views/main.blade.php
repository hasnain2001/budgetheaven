...
.slider-image {
  ...
  border: 5px solid rgba(255, 255, 255, 0.8); /* Semi-transparent white border */
  border-radius: 15px; /* Adds rounded corners */
  box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3); /* Adds a shadow for a 3D effect */
...
<div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{ asset('images/slider.png') }}" class="d-block w-100 slider-image" alt="Slide 1" loading="lazy">
      </div>
      <div class="carousel-item">
        <img src="{{ asset('images/caraosel-1.png') }}" class="d-block w-100 slider-image" alt="Slide 2" loading="lazy">
      </div>
      <div class="carousel-item">
        <img src="{{ asset('images/caraosel-2.png') }}" class="d-block w-100 slider-image" alt="Slide 3" loading="lazy">
      </div>
    </div>
  ...
  <div class="col-md-4 col-sm-6">
    <div class="coupon-card  h-100 card rounded shadow">
      ...
      <div class="coupon-body p-4">
        <strong class=" card-title mb-3 text-dark font-italic">{{ $coupon->name }}</strong>
